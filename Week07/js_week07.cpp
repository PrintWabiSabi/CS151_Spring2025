...
{   int width = 10;
    ...
    cout << setw(width) << true << setw(width) << true << set(width) << true!= true << endl;
    cout << setw(width) << true << setw(width) << true << set(width) << true!= false << endl;
    cout << setw(width) << true << setw(width) << true << set(width) << false = true << endl;
    cout << setw(width) << true << setw(width) << true << set(width) << true!= t << endl;
